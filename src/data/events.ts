...
export const events: Event[] = [
  // Engineering Events
  {
    ...
    rules: [
      ...
      "Submission: PDF format, 6-8 pages, Times New Roman 12, 1.5 spacing.",
    ...
    registrationLinks: {
      ...
      "Diploma": "https://forms.gle/ZFSNSSbqi99YZM2GA"
    }
  },
  {
    id: "project-expo",
  ...
  },
  {
    ...
    description: "Step forward and exhibit your technical brilliance in an engaging and competitive environment. Test your knowledge, boost your confidence, and shine among the best minds.",
    rules: [
      "The Screening Test will be conducted for all registered participants.",
      "The Screening Test will consist of 30 MCQs on General Awareness, to be completed within 20 minutes.",
      "The Screening Test will be conducted individually.",
      "Based on the Screening Test results, qualified candidates will be shortlisted and grouped into 5 teams, consisting of 3 members each.",
      "The selected teams will participate in the next two team rounds: Technical Round and Final Round (Audio/Visual Round).",
      "Certificates and prizes will be distributed to the 1st and 2nd prize winners at their respective departments.",
      "The decision of the Quiz Committee will be final and binding."
    ],
    date: "March 6, 2026",
    ...
    registrationLinks: {
      ...
      "Diploma": "https://forms.gle/x13j8aTw5dX4U7Nj6"
    }
  },
  {
    id: "idea-pitch",
  ...
  },
  {
    ...
    category: "Engineering",
    registrationLinks: {
      "Anyone Can Participate": "https://forms.gle/Urr3vCarU4kBiqac7"
    }
  },
  {
    id: "photography",
    ...
    rules: [
      "Registration upto 04-Mar-2026 5:00PM.",
      "Spot Registration is also available on 05-Mar-2026 at the Registration Counters.",
    ...
    category: "Engineering",
    registrationLinks: {
      "Anyone Can Participate": "https://forms.gle/MUbUHBkzp1yoKvEv6"
    }
  },
  {
    id: "esports",
    ...
    rules: [
      ...
      "Certificates: Only Finalists will receive Certificates.",
    ...
    category: "Engineering",
    prizePool: "Only Finalists will receive Certificates."
  },
  {
    id: "ipl-bidding",
    title: "FANTASY FEVER",
  ...
  // MBA Events
  {
    ...
    description: "Presentation PPT on Innovative Business Ideas.",
    rules: [
      "No Of participants: 2 No",
      "Presentation PPT on Innovative Business Ideas",
      "Time Duration: 15 Min",
      "Spot Registration on the Day of the Event (05-03-2026)",
      "CO-ORDINATOR: Dr. S. CHAND BASHA (9866087091)",
      "Email: mba.drchandbasha@sacet.ac.in"
    ],
    date: "March 5, 2026",
    time: "10:00 AM",
  ...
  },
  {
    ...
    subtitle: "Paper Presentation",
    description: "Topic: Contemporary Issues in Business Management - 2026",
    rules: [
      "No. of Participants: 3 No",
      "Topic: Contemporary Issues in Business Management - 2026",
      "Time Duration: 15 Min",
      "Last Date of Submission of Abstract: 02-03-2026",
      "Send abstract to: ameer.stanns@gmail.com",
      "COORDINATOR: SD AMEER JAN I (9989873020)"
    ],
    date: "March 5, 2026",
    time: "11:30 AM",
  ...
  },
  {
    ...
    description: "Topic: Covered All Business-Related Issues",
    rules: [
      "No. of Participants: 3 No",
