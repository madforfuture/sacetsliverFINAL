    ...
    <footer id="contact" className="bg-luxury-gray border-t border-white/5 pt-16 pb-8">
      <div className="container mx-auto px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="https://www.instagram.com/sacetchirala_official" target="_blank" rel="noopener noreferrer" className="text-silver-400 hover:text-gold-300 transition-colors"><Instagram size={20} /></a>
              <a href="https://www.youtube.com/sacetchirala" target="_blank" rel="noopener noreferrer" className="text-silver-400 hover:text-gold-300 transition-colors"><Youtube size={20} /></a>
              <a href="https://www.facebook.com/sacetchirala" target="_blank" rel="noopener noreferrer" className="text-silver-400 hover:text-gold-300 transition-colors"><Facebook size={20} /></a>
            </div>
          </div>
          ...
          <div className="md:col-span-2">
            ...
            <ul className="space-y-4 text-sm text-silver-400">
              ...
              <li className="flex items-center">
                ...
                <span>sacetrajathotsav@gmail.com</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-white/5 pt-8 text-center text-xs text-silver-500">
          ...
          <p className="mt-2 text-silver-600">Developed by Akash Sankarasetty</p>
        </div>
      </div>
    </footer>
  );
