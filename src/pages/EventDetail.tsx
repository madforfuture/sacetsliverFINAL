        ...
        >
          ...
          <div className="glass-card p-8 rounded-2xl">
            ...
            <p className="text-silver-400">
              {event.prizePool || "Win exciting cash prizes, certificates, and trophies. Participation certificates will be provided to all registered candidates."}
            </p>
          </div>
        </motion.div>
      </div>
        ...
        {showBranchModal && (
          ...
          >
            <motion.div
              ...
              className="glass-card w-full max-w-md p-8 rounded-2xl relative border border-gold-500/30 shadow-2xl shadow-gold-500/10 max-h-[90vh] overflow-y-auto custom-scrollbar"
