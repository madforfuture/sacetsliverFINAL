    ...
    <div className="min-h-screen pt-20">
      ...
      <section className="relative min-h-[80vh] flex flex-col items-center justify-center text-center px-4 py-20">
        ...
        >
          ...
          <h1 className="text-5xl md:text-7xl lg:text-9xl font-serif font-bold mb-6 text-gradient-silver tracking-tight pb-4 leading-tight">
          ...
          <div className="mb-12 flex flex-col sm:flex-row items-center justify-center gap-6">
            ...
            <motion.a
              href="https://sacet.ac.in/"
              target="_blank"
              rel="noopener noreferrer"
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="inline-block px-8 py-4 border border-gold-400 text-gold-400 font-bold tracking-widest uppercase text-sm rounded-full hover:bg-gold-400/10 transition-all"
            >
              About College
            </motion.a>
          </div>
